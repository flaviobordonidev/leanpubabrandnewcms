...
Attiviamo `active_storage` per l'ambiente di sviluppo (`development`) e manteniamo in locale gli uploads dei files; quindi li manentiamo sull'istanza `ubuntufla` di *Ubuntu multipass*.
...
***code 04 - .../app/models/user.rb - line:08***
...
[tutto il codice](https://github.com/flaviobordonidev/leanpubabrandnewcms/blob/master/ubuntudream/04-activestorage-filesupload/02_05-users_controller.rb)
