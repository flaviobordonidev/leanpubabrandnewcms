# <a name="top"></a> Cap 1 - Overview

Installiamo come IDE il programma vscode (Visual Studio Code) della microsoft.



## Risorse esterne

- [vscode for Mac](https://code.visualstudio.com/download)
