{id: 50-elisinfo-04-Companies-09-companies_index_search}
# Cap 4.9 -- Implementiamo il search
...
## Apriamo il branch "Companies Index Search"
...
{caption: "confronto fra form_with e form_tag -- codice n/a", format: HTML+Mako, line-numbers: false}
```
  <%= form_with(url: "", method: "get", local:true) do %>
