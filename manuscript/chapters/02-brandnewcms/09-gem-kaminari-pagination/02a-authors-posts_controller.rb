module Authors
  class PostsController < ApplicationController
    ...
    def index
      ...
      #@posts = Post.order_by_id.page(params[:page])
      @posts = current_author.posts.order_by_id.page(params[:page])
    ...
    private
      ...
      def post_params
        params.require(:post).permit(:title, :incipit, :content, :type, :video_youtube, :video_vimeo, :seocontent, :date_chosen, :user_id, :header_image, :main_image, :published, :published_at)
      end
  end
end
